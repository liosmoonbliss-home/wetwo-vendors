      ...
      <div className="page-content">
        ...
        <div className="tiers-grid">
          ...
          <div className={`tier-card ${vendor.plan === 'pro' ? 'current' : ''}`}>
            ...
            <div className="tier-daily">That's $9.90/day — lunch money</div>
            <ul className="tier-features">
              <li>✓ Everything in Free</li>
        ...
        <div className="real-value-card">
          ...
          <p className="real-value-text">
            The commission is spending money — a nice bonus that shows up in your account. 
            But the <strong>real</strong> return is what this system does for your main business:
          </p>
        ...
        <div className="math-card">
          ...
          <div className="payback-card">
            ...
            <p className="payback-line">
              WeTwo gives you the tools for free. The paid plan adds commission — spending money that 
              shows up while the real value is the bookings, the leads, and the network you're building.
            </p>
