...
// ============================================================
// WeTwo — Vendor Toolbox v4.1
// Tier-aware: contact capture messaging adjusts per tier
// Reinforced theme: marketing that pays you
// ============================================================
...
const TIER_CONTACTS: Record<string, boolean> = {
...
export default function VendorToolbox({ vendorRef, tier, showCouplesSection = true }: ToolboxProps) {
  ...
  const hasContacts = TIER_CONTACTS[vTier] || false
