    ...
    <div>
      ...
      <div className="page-content">
        ...
        <div className="hero-explainer">
          <h2>Your marketing system is live — let's put it to work.</h2>
          <p className="hero-lead">A free branded landing page, a free store with thousands of products, and a free built-in incentive engine — all working together under your name. Here's the flow:</p>
          <div className="hero-flow">
            <div className="flow-step">
              <span className="flow-num">1</span>
              <span>Your <strong>landing page</strong> builds trust and captures leads for your core business</span>
            </div>
            <div className="flow-arrow">→</div>
            <div className="flow-step">
              <span className="flow-num">2</span>
              <span>Your <strong>store</strong> turns strangers into customers — and gives you their <strong>name and email</strong></span>
            </div>
            <div className="flow-arrow">→</div>
            <div className="flow-step">
              <span className="flow-num">3</span>
              <span>Now they're in <strong>your list</strong> — market your main business to them forever and earn <strong style={{ color: '#22c55e' }}>{t.pool}%</strong> on every sale along the way</span>
            </div>
          </div>
          <p className="hero-costco">The store makes you money. But the real value is every buyer becomes a contact you own — a customer for life. That's the system.</p>
        </div>
        ...
        <div className="section-card" style={{ borderLeft: '4px solid #22c55e' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
            ...
            <div style={{ flex: 1 }}>
              <h3 className="section-title">You're earning {t.pool}% — and building your list</h3>
              <p className="section-desc">
                Anyone who buys from your store — you earn <strong style={{ color: '#22c55e' }}>{t.pool}%</strong> on 
                the sale <em>and</em> you get their <strong>name and email</strong>. That's a new contact you can market 
                your core business to — forever. Share this link anywhere:
              </p>
              <StoreLinkRow vendorRef={vendor.ref} />
              <p className="section-desc" style={{ marginTop: '12px', marginBottom: 0, fontSize: '12px', color: '#9a8d80' }}>
                That {t.pool}% is your <strong style={{ color: '#2c2420' }}>pool</strong>. Keep all of it, or share some as 
                incentives to bring more people in. More incentives = more buyers = more names on your list = more clients for your main business.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* ===== UPGRADE TEASE (free tier only) ===== */}
        {tier === 'free' && (
          <div className="section-card" style={{ background: 'linear-gradient(135deg, rgba(229,165,10,0.04), rgba(34,197,94,0.04))', borderColor: 'rgba(229,165,10,0.3)' }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
              <span style={{ fontSize: '22px', flexShrink: 0, marginTop: '2px' }}>🚀</span>
              <div>
                <h3 className="section-title">Give more, list more, earn more — and still profit on every sale</h3>
                <p className="section-desc" style={{ marginBottom: 0 }}>
                  Right now your {t.pool}% pool means every discount you give reduces what you keep. 
                  Upgrade and your pool grows — so you can offer the <strong>maximum 20% off</strong> to 
                  everyone, <strong style={{ color: '#22c55e' }}>still earn on every sale</strong>, and 
                  flood your contact list with new names. Bigger incentives = more buyers = more leads for your main business. It compounds.
                </p>
              </div>
            </div>
          </div>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '12px' }}>
        ...
        <div>
          ...
          <p className="section-desc">
            ...
            real money toward her honeymoon. You choose how much: 10%, 15%, or 20%.
          </p>
          <p className="section-desc">
            <span style={{ color: '#c9944a', fontWeight: 700 }}>It comes out of your {pool}% pool — not out of pocket.</span> You 
            keep the rest. And here's the real win: every single guest who buys a gift is now <strong>in your contact list</strong>. 
            One wedding = 150 new names you can market to.
          </p>
          <p className="section-desc" style={{ marginBottom: 0, fontSize: '12px', color: '#9a8d80' }}>
            The more generous the offer, the more brides choose you — and the more guests flow into your list.
          </p>
        </div>
      </div>
...
function HowItWorks({ pool }: { pool: number }) {
  return (
    <div className="sub-page">
      <h2>💡 How it works</h2>
      <p>Every product in your store is priced at or below market. We don't make margin — we make memberships, like Costco for small businesses.</p>
      <p>You earn <strong style={{ color: '#22c55e' }}>{pool}%</strong> on everything sold through your store. That's your pool — yours to keep or share as incentives (up to 20%).</p>

      <h3>The real value isn't the commission</h3>
      <p>The commission is great. But the real value is this: every single person who buys from your store gives you their <strong>name and email</strong>. That's a lead for your main business that you didn't have yesterday.</p>
      <p>Someone buys a toaster using your 15% code. You email them: <em>"Thanks for the purchase! We're the best entertainment company in the tri-state area — here's our landing page. As a customer, you get a special deal on your next event."</em></p>
      <p>Now they're not just a product buyer. They're a prospect for your core business. Give them another store discount as a thank-you after the event. The cycle repeats. <strong>Customer for life.</strong></p>

      <h3>For couples</h3>
      <p>Give a bride your registry link. She creates a registry. Her guests buy gifts. She gets cashback toward her honeymoon — paid from your pool, not your pocket. Every guest who buys is a new contact in your list. One wedding = up to 150 new names.</p>

      <h3>For everyone else</h3>
      <p>Generate a discount code. Share it on social, text it to past clients, hand it out at events. They save at checkout. You earn your pool minus the discount. And you get their contact info to market your main business to them.</p>

      <h3>The flywheel</h3>
      <p>Discount → purchase → new contact → market your business → new client → reward with another discount → another purchase → another contact. It compounds. The store isn't just a revenue stream — it's the engine that feeds everything else you do.</p>
    </div>
  )
}
  ...
  return (
    <div className="sub-page">
      ...
      {[
        ...
        { num: '2', title: 'Text 5 past clients', desc: '"I have something for you — exclusive savings on thousands of products. Want the link?" Every one who buys = a contact you can market to again.' },
        { num: '3', title: 'Generate your first code', desc: 'Pick 10% or 15%, send it to your best contacts. Every order gives you a name and email for your list.' },
        { num: '4', title: 'Post on Instagram', desc: '"I have a gift for you 🎁 DM me GIFT for exclusive access." Every DM = a warm lead. Every purchase = a customer for life.' },
        { num: '5', title: 'Set up one registry', desc: 'One bride. 150 guests buying gifts. That\'s 150 new contacts in your list — plus cashback that makes the bride your biggest fan.' },
      ].map((step, i) => (
...
const sharedStyles = `
  ...
  .hero-lead { font-size: 14px; color: rgba(255,255,255,0.7); margin: 0 0 16px; line-height: 1.6; }
