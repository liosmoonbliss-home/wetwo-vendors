#!/bin/bash
echo "🔑 Updating to v4 — Network Effect + Smart Claude..."
echo ""
...
echo ""
echo "🎉 All 4 files updated! Restart dev server (npm run dev) and refresh."
echo ""
echo "What changed:"
echo "  • Dashboard: Network effect section (your name travels with every share)"
echo "  • Dashboard: Bigger Claude card with example questions"
echo "  • Links: WeTwo Wedding Buyers Club in every message (from v3)"
echo "  • Claude API: Full system knowledge — advisor, not just copywriter"
echo "  • Claude page: Two sections (Write for me / Help me understand)"
